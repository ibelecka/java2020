...
public class TenMinWalk {
	/*
	 * TODO You live in the city of Cartesia where all roads are laid out in a
	 * perfect grid. You arrived ten minutes too early to an appointment, so you
	 * decided to take the opportunity to go for a short walk. The city provides its
